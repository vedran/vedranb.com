...
Geohot did eventually hack his way to a solution that completed all test cases in the time limit. However, this incremental improvement process took over _5 hours_, most of which was spent on finicky code optimizations (memoization & hardcoded buffers, rewriting the algorithm C, changing data structures to fit more data into the processor's cache) rather than the novel algorithmic improvements that the problem truly required.
...
<blockquote class="twitter-tweet">
  <p lang="en" dir="ltr">
    Reading{" "}
    <a href="https://twitter.com/JamesClear?ref_src=twsrc%5Etfw">@JamesClear</a>
    &#39;s blog and watching{" "}
    <a href="https://twitter.com/realGeorgeHotz?ref_src=twsrc%5Etfw">
      @realGeorgeHotz
    </a>{" "}
    livestreams has helped me discover bad habits in my problem solving
    strategy.
    <br />
    <br />
    I&#39;ve narrowed it down to the theme of the Pareto principle and developing
    respect for the problems you&#39;re working on.<a href="https://t.co/qZ4tBp0oeA">
      https://t.co/qZ4tBp0oeA
    </a>
  </p>
  &mdash; Vedran Budimcic (@vbudimcic){" "}
  <a href="https://twitter.com/vbudimcic/status/1234351395261673473?ref_src=twsrc%5Etfw">
    March 2, 2020
  </a>
</blockquote>
<script
